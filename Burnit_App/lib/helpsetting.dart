//Help Setting page implementation
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            width: 350.0,
            alignment:Alignment.centerLeft,
            child: const Text('Help',style: TextStyle(color: Colors.black, fontSize: 20,
              fontWeight: FontWeight.bold,),),
          ),
          Container(
            margin: EdgeInsets.all(5),
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Container(
                  width: 220.0,
                  alignment:Alignment.centerLeft,
                  child: const Text('Help Center',style: TextStyle(color: Colors.black, fontSize: 16,
                    fontWeight: FontWeight.bold,),),
                ),
                Container(
                  width: 30.0,
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Container(
                  width: 220.0,
                  alignment:Alignment.centerLeft,
                  child: const Text('App info',style: TextStyle(color: Colors.black, fontSize: 16,
                    fontWeight: FontWeight.bold,),),
                ),
                Container(
                  width: 30.0,
