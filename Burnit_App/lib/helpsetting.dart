...
class  MyCustomFormState extends State < HelpSetting>{
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          alignment:Alignment.centerLeft,
                          padding: const EdgeInsets.symmetric(horizontal: 30, vertical: 0),
                          child: const Text('Help Center',style: TextStyle(color: Colors.black, fontSize: 18,
                            fontWeight: FontWeight.bold,),),
                        ),
                        Container(
                          width: 30.0,
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          alignment:Alignment.centerLeft,
                          padding: const EdgeInsets.symmetric(horizontal: 30, vertical: 0),
                          child: const Text('App info',style: TextStyle(color: Colors.black, fontSize: 18,
                            fontWeight: FontWeight.bold,),),
                        ),
                        Container(
                          width: 30.0,
