      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            width: 350.0,
            alignment:Alignment.centerLeft,
            child: const Text('Notification Setting',style: TextStyle(color: Colors.black, fontSize: 20,
              fontWeight: FontWeight.bold,),),
          ),
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                Container(
                    ...
                    alignment:Alignment.centerLeft,
                  child: RichText(
                    text: TextSpan(text: 'Push Notification',
            ...
            child: ListView(
              ...
              children: <Widget>[
                Container(
                  ...
                  alignment:Alignment.centerLeft,
                  child: RichText(
                    text: TextSpan(text: 'Do Not Disturb Mode ',
                      style: TextStyle(color: Colors.black, fontSize: 16,fontWeight: FontWeight.bold,),
                      children: [
                        TextSpan(text: '\nChange your notification setting', style: TextStyle(color: Colors.black54, fontSize: 14,fontWeight: FontWeight.bold,),
            ...
            child: ListView(
              ...
              children: <Widget>[
                Container(
                  ...
                  alignment:Alignment.centerLeft,
                  child: RichText(
                    text: TextSpan(text: 'Chat Notification',
                      style: TextStyle(color: Colors.black, fontSize: 16,fontWeight: FontWeight.bold,),
                      children: [
                        TextSpan(text: '\nChange your notification setting', style: TextStyle(color: Colors.black54, fontSize: 14,fontWeight: FontWeight.bold,),
            ...
            child: ListView(
              ...
              children: <Widget>[
                Container(
                  ...
                  alignment:Alignment.centerLeft,
                  child: RichText(
                    text: TextSpan(text: 'Notification for Upcoming Exercise',
                      style: TextStyle(color: Colors.black, fontSize: 16,fontWeight: FontWeight.bold,),
                      children: [
                        TextSpan(text: '\nChange your notification setting', style: TextStyle(color: Colors.black54, fontSize: 14,fontWeight: FontWeight.bold,),
            ...
            child: ListView(
              ...
              children: <Widget>[
                Container(
                  ...
                  alignment:Alignment.centerLeft,
                  child: RichText(
                    text: TextSpan(text: 'Notification for Posts',
                      style: TextStyle(color: Colors.black, fontSize: 16,fontWeight: FontWeight.bold,),
                      children: [
                        TextSpan(text: '\nChange your notification setting', style: TextStyle(color: Colors.black54, fontSize: 14,fontWeight: FontWeight.bold,),
                        )
