...
class InviteFriendsSetting extends StatelessWidget {
  @override
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            width: 350.0,
            alignment:Alignment.centerLeft,
            child: const Text('Invite Friends',style: TextStyle(color: Colors.black, fontSize: 20,
              fontWeight: FontWeight.bold,),),
          ),
          Container(
            margin: EdgeInsets.all(5),
