      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            alignment:Alignment.center,
            child: RichText(
              text: TextSpan(text: 'Jonathan Doe (25)',
                style: TextStyle(color: Colors.black, fontSize: 26,fontWeight: FontWeight.bold,),
                children: [
                  TextSpan(text: '\n          +16942451564', style: TextStyle(color: Colors.black54, fontSize: 18,fontWeight: FontWeight.bold,),
          ...
          Container(
            ...
            child: new RaisedButton(
              ...
              color: Colors.purple,
              child: const Text('My Completed Exercise',style: TextStyle(
                fontSize: 18.0,
                fontWeight: FontWeight.bold,
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    alignment:Alignment.centerRight,
                    child: RichText(
                        text: TextSpan(text: '27 July, 2000\n\nNew York, USA\n\n145cm\n\n190ibs', style: TextStyle(color: Colors.black, fontSize: 16,fontWeight: FontWeight.bold,)
                        )
                    ),
                  ),
                ),
          ...
          Container(
            ...
            alignment:Alignment.center,
            decoration: BoxDecoration(
              color: Color(0xffe4e14),
              //color: Color(0x0fffafaA),
              //color: Color(0xFBFBFB),
              borderRadius: BorderRadius.circular(8.0),),
            child: new RaisedButton(
              elevation: 0,
              textColor: Colors.red,
              //color: Color(0xffe4e14),#FFFAFA
              color: Color(0x0fffafaA),
